...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Sacramento.iglesia' to match new field type.
        db.rename_column(u'sacramentos_sacramento', 'iglesia', 'iglesia_id')
        # Changing field 'Sacramento.iglesia'
        db.alter_column(u'sacramentos_sacramento', 'iglesia_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sacramentos.Iglesia']))
        # Adding index on 'Sacramento', fields ['iglesia']
        db.create_index(u'sacramentos_sacramento', ['iglesia_id'])


    def backwards(self, orm):
        # Removing index on 'Sacramento', fields ['iglesia']
        db.delete_index(u'sacramentos_sacramento', ['iglesia_id'])


        # Renaming column for 'Sacramento.iglesia' to match new field type.
        db.rename_column(u'sacramentos_sacramento', 'iglesia_id', 'iglesia')
        # Changing field 'Sacramento.iglesia'
        db.alter_column(u'sacramentos_sacramento', 'iglesia', self.gf('django.db.models.fields.CharField')(max_length=30))
