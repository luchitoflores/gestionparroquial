...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PerfilUsuario.full_name'
        db.add_column(u'sacramentos_perfilusuario', 'full_name',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Intenciones.ofrenda'
        db.alter_column(u'sacramentos_intenciones', 'ofrenda', self.gf('django.db.models.fields.DecimalField')(max_digits=7, decimal_places=2))

    def backwards(self, orm):
        # Deleting field 'PerfilUsuario.full_name'
        db.delete_column(u'sacramentos_perfilusuario', 'full_name')


        # Changing field 'Intenciones.ofrenda'
        db.alter_column(u'sacramentos_intenciones', 'ofrenda', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2))
