...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'sacramentos_iglesia', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default='2014-05-01', blank=True),
                      keep_default=False)

        # Adding field 'Iglesia.modified'
        db.add_column(u'sacramentos_iglesia', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default='2014-05-01', blank=True),
                      keep_default=False)
