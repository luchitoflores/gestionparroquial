...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ParametrizaParroquia.libro'
        db.add_column(u'sacramentos_parametrizaparroquia', 'libro',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['sacramentos.Libro'], unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ParametrizaParroquia.libro'
        db.delete_column(u'sacramentos_parametrizaparroquia', 'libro_id')
