...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Libro.numero_libro'
        db.delete_column(u'sacramentos_libro', 'numero_libro')

        # Adding field 'Libro.nombre'
        db.add_column(u'sacramentos_libro', 'nombre',
                      self.gf('django.db.models.fields.CharField')(max_length='50', null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Libro.numero_libro'
        db.add_column(u'sacramentos_libro', 'numero_libro',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=None),
                      keep_default=False)

        # Deleting field 'Libro.nombre'
        db.delete_column(u'sacramentos_libro', 'nombre')
