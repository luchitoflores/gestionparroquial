...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Libro.estado'
        db.delete_column(u'sacramentos_libro', 'estado')

        # Adding field 'Libro.principal'
        db.add_column(u'sacramentos_libro', 'principal',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Libro.estado'
        db.add_column(u'sacramentos_libro', 'estado',
                      self.gf('django.db.models.fields.CharField')(default=False, max_length=20),
                      keep_default=False)

        # Deleting field 'Libro.principal'
        db.delete_column(u'sacramentos_libro', 'principal')
