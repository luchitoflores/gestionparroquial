...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Matrimonio.novia'
        db.alter_column(u'sacramentos_matrimonio', 'novia_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['sacramentos.PerfilUsuario']))
        # Adding unique constraint on 'Matrimonio', fields ['novia']
        db.create_unique(u'sacramentos_matrimonio', ['novia_id'])


        # Changing field 'Matrimonio.novio'
        db.alter_column(u'sacramentos_matrimonio', 'novio_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['sacramentos.PerfilUsuario']))
        # Adding unique constraint on 'Matrimonio', fields ['novio']
        db.create_unique(u'sacramentos_matrimonio', ['novio_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Matrimonio', fields ['novio']
        db.delete_unique(u'sacramentos_matrimonio', ['novio_id'])

        # Removing unique constraint on 'Matrimonio', fields ['novia']
        db.delete_unique(u'sacramentos_matrimonio', ['novia_id'])


        # Changing field 'Matrimonio.novia'
        db.alter_column(u'sacramentos_matrimonio', 'novia_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sacramentos.PerfilUsuario']))

        # Changing field 'Matrimonio.novio'
        db.alter_column(u'sacramentos_matrimonio', 'novio_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sacramentos.PerfilUsuario']))
