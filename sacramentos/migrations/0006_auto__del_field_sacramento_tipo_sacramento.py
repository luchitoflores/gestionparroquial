...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Sacramento.tipo_sacramento'
        db.delete_column(u'sacramentos_sacramento', 'tipo_sacramento')


    def backwards(self, orm):
        # Adding field 'Sacramento.tipo_sacramento'
        db.add_column(u'sacramentos_sacramento', 'tipo_sacramento',
