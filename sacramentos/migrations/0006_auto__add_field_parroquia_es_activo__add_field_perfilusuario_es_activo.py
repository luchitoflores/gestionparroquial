...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Parroquia.es_activo'
        db.add_column(u'sacramentos_parroquia', 'es_activo',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PerfilUsuario.es_activo'
        db.add_column(u'sacramentos_perfilusuario', 'es_activo',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ParametrizaDiocesis.es_activo'
        db.add_column(u'sacramentos_parametrizadiocesis', 'es_activo',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'AsignacionParroquia.es_activo'
        db.add_column(u'sacramentos_asignacionparroquia', 'es_activo',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'NotaMarginal.es_activo'
        db.add_column(u'sacramentos_notamarginal', 'es_activo',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Intenciones.es_activo'
        db.add_column(u'sacramentos_intenciones', 'es_activo',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Sacramento.es_activo'
        db.add_column(u'sacramentos_sacramento', 'es_activo',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Libro.es_activo'
        db.add_column(u'sacramentos_libro', 'es_activo',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ParametrizaParroquia.es_activo'
        db.add_column(u'sacramentos_parametrizaparroquia', 'es_activo',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PeriodoAsignacionParroquia.es_activo'
        db.add_column(u'sacramentos_periodoasignacionparroquia', 'es_activo',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Parroquia.es_activo'
        db.delete_column(u'sacramentos_parroquia', 'es_activo')

        # Deleting field 'PerfilUsuario.es_activo'
        db.delete_column(u'sacramentos_perfilusuario', 'es_activo')

        # Deleting field 'ParametrizaDiocesis.es_activo'
        db.delete_column(u'sacramentos_parametrizadiocesis', 'es_activo')

        # Deleting field 'AsignacionParroquia.es_activo'
        db.delete_column(u'sacramentos_asignacionparroquia', 'es_activo')

        # Deleting field 'NotaMarginal.es_activo'
        db.delete_column(u'sacramentos_notamarginal', 'es_activo')

        # Deleting field 'Intenciones.es_activo'
        db.delete_column(u'sacramentos_intenciones', 'es_activo')

        # Deleting field 'Sacramento.es_activo'
        db.delete_column(u'sacramentos_sacramento', 'es_activo')

        # Deleting field 'Libro.es_activo'
        db.delete_column(u'sacramentos_libro', 'es_activo')

        # Deleting field 'ParametrizaParroquia.es_activo'
        db.delete_column(u'sacramentos_parametrizaparroquia', 'es_activo')

        # Deleting field 'PeriodoAsignacionParroquia.es_activo'
        db.delete_column(u'sacramentos_periodoasignacionparroquia', 'es_activo')
