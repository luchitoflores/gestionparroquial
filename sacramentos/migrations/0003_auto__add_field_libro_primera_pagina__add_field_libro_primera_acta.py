...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Libro.primera_pagina'
        db.add_column(u'sacramentos_libro', 'primera_pagina',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Libro.primera_acta'
        db.add_column(u'sacramentos_libro', 'primera_acta',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Libro.primera_pagina'
        db.delete_column(u'sacramentos_libro', 'primera_pagina')

        # Deleting field 'Libro.primera_acta'
        db.delete_column(u'sacramentos_libro', 'primera_acta')
