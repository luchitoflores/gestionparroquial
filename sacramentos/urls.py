...
from sacramentos.views import (
    ...
    IglesiaListView, IglesiaCreateView,
    IglesiaUpdateView,  # AsignarParroquiaCreate, AsignarParroquiaUpdate, AsignarParroquiaList,
    asignar_parroquia_create, asignar_parroco_a_parroquia, asignar_parroquia_update, asignar_parroco_list,
    parroco_periodos_asignacion_list, parroco_periodos_asignacion_update, nuevo_periodo_asignacion,
...
urlpatterns = patterns('',
                       ...
                       # 	name='personas'),
                       url(r'^personas/$', redireccionar, name='personas'),  #urls de usuarios
                       ...
                       url(r'^reporte/sacerdote/(?P<pk>\d+)/$', reporte_sacerdotes_parroquias,
                           name='reporte_sacerdotes'),
                       url(r'^usuario_certificado/(?P<pk>\d+)/$', usuario_reporte_honorabilidad,
                           name='usuario_certificado'),  # Urls Administradores
                       ...
                       url(r'^asignar/secretaria/(?P<pk>\d+)/$', asignar_secretaria_update,
                           name='asignar_secretaria_update'),
                       ...
                       url(r'^api/crear/sacerdote/$', 'sacramentos.rest.sacerdote_create_ajax',
                           name='api_create_sacerdote'),
                       ...
                       # url(r'^libro/(?P<pk>\d+)/$',libro_pdf, name='libro_update'),  #urls de sacramentos
                       url(r'^sacramentos/$',
                           login_required(TemplateView.as_view(template_name='sacramentos.html'), login_url='/login/'),
                           name='sacramentos'),
                       url(r'^reporte/$',
                           login_required(TemplateView.as_view(template_name='reportes.html'), login_url='/login/'),
                           name='reportes'),
                       ...
                       # 	name='parametros'),  #urls de matrimonio y reporte

                       url(r'^matrimonio/$', MatrimonioListView.as_view(), name='matrimonio_list'),
                       url(r'^matrimonio/no_vigentes/$', MatrimonioNoVigenteListView.as_view(),
                           name='matrimonio_list_no_vigentes'),
                       ...
                       url(r'^matrimonio_certificado/(?P<pk>\d+)/$', matrimonio_certificado,
                           name='matrimonio_certificado'),  #urls de Nota Marginal para crear con bautismo y matrimonios
                       ...
                       url(r'^api/crear/nota_matrimonio/$', 'sacramentos.rest.nota_create_matrimonio_ajax',
                           name='api_create_nota_matrimonio'),  #urls de Bautismo
                       ...
                       url(r'^directorio/parroquias/$', DirectorioParroquiasListView.as_view(),
                           name='directorio_parroquias'),  #urls para Iglesias
                       ...
                       url(r'^parroco/periodos/asignacion/(?P<pk>\d+)/$', parroco_periodos_asignacion_list,
                           name='parroco_periodos_asignacion_list'),
                       url(r'^crear/parroco/periodo/asignacion/(?P<pk>\d+)/$', nuevo_periodo_asignacion,
                           name='nuevo_periodo_asignacion'),
                       # Edición de los periodos de asignación de un párroco a una parroquia
                       url(r'^parroco/periodos/(?P<pk>\d+)/asignacion/$', parroco_periodos_asignacion_update,
                           name='parroco_periodos_asignacion_update'),
                       ...
                       url(r'^api/usuario/$', 'sacramentos.rest.buscar_usuarios', name='api_usuario_list'),
                       url(r'^api/crear/padre/$', 'sacramentos.rest.padre_create_ajax', name='api_create_padre'),
                       url(r'^api/crear/secretaria/$', 'sacramentos.rest.secretaria_create_ajax',
                           name='api_create_secretaria'),
                       ...
                       url(r'^crear/parametros/parroquia/$', parametriza_parroquia_create,
                           name='parametriza_parroquia_create'),  #urls del api rest parroquias
